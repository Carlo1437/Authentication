    ...
    >
      ...
      >
        <div class="text-center mb-10">
          <h2
            class="text-4xl font-bold mb-2 bg-gray-700 to-gray-200 bg-clip-text text-transparent"
          >
            Welcome Back
          </h2>
          ...
          <div class="space-y-2">
            ...
            <div class="relative group">
              <input
                ...
                placeholder="••••••••"
                required
                class="w-full px-4 py-3.5 pr-12 bg-slate-900/50 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all duration-300"
              />
              <button
                type="button"
                @click="showPassword = !showPassword"
                class="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-200 transition-colors duration-200 focus:outline-none"
                tabindex="-1"
              >
                <svg
                  v-if="!showPassword"
